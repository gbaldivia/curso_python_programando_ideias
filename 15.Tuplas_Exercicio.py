...
Porém, existem 3 portões protegidos por senha do tipo TUPLA.
...
Kiko deve criar um programa que imprima na tela as três senhas no seguinte formato:
print(f'Portão X: {senha_do_portão_X}').

# Dicas
Portão 1 = (29, 54, 45) [Alterar todas as dezenas para 0]

Portão 2 = (12, 28, 37, 54) [A soma dos elementos 2 e 3 é o primeiro elemento da senaha,
a soma dos elementos 1 e 4 é o segundo elemento da senha]

Portão 3 = (16, 86, 78, 32, 85, 12) [O valor mínimo é o primeiro elemento da senha,
o valor máximo é o segundo elemento da senha]
"""
portao1 = (29, 54, 45)
portao2 = (12, 28, 37, 54)
